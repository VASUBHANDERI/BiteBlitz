...
CREATE POLICY "Allow all authenticated all operations" ON "public"."order_items" TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Allow only Authenticated Users to Select" ON "public"."products" TO authenticated USING (true) WITH CHECK (true);
